/*
 * Module_name: checkpoint_sender.h
 * Author: Barneyliu
 * Time: 2019-01-10
 * Description:
 *
...
{
public:
  CheckpointSender(const nodeid_t iSendNodeID,Config * poConfig, Learner * poLearner,
		     SMFac * poSMFac, CheckpointMgr * poCheckpointMgr);
  virtual ~CheckpointSender();
  void Stop();
  void run();
  void End();
