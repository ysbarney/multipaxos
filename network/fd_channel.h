...
class MULTIPAXOS_EXPORT FdChannel {
public:
    enum EventType {
        kNone = 0x00,
        kReadable = 0x02,
...
public:
    FdChannel(EventLoop* loop, multipaxos_socket_t fd,
...
private:
    void HandleEvent(multipaxos_socket_t fd, short which);
    static void HandleEvent(multipaxos_socket_t fd, short which, void* v);
