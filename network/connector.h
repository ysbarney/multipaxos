...
class DNSResolver;
class TCPClient;
class MULTIPAXOS_EXPORT Connector : public std::enable_shared_from_this<Connector> {
public:
    typedef std::function<void(multipaxos_socket_t sockfd, const std::string& /*local addr*/)> NewConnectionCallback;
