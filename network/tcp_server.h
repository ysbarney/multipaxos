...
// </code>
//
class MULTIPAXOS_EXPORT TCPServer : public ThreadDispatchPolicy, public ServerStatus {
public:
...
private:
    ...
    void HandleNewConn(multipaxos_socket_t sockfd, const std::string& remote_addr/*ip:port*/, const struct sockaddr_in* raddr);
