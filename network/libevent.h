...
extern "C" {
    struct evdns_base;
    MULTIPAXOS_EXPORT struct event* event_new(struct event_base* base, evpp_socket_t fd, short events, void(*cb)(int, short, void*), void* arg);
    MULTIPAXOS_EXPORT void event_free(struct event* ev);
    MULTIPAXOS_EXPORT evhttp_connection* evhttp_connection_base_new(
